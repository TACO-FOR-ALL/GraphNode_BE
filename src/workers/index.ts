...
import { GraphGenerationProgressHandler } from './handlers/GraphGenerationProgressHandler';
...
async function startWorker() {
  ...
  const handlers: Record<string, JobHandler> = {
    ...
    [TaskType.GRAPH_GENERATION_PROGRESS]: new GraphGenerationProgressHandler(),
