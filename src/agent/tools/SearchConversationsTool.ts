  ...
  readonly definition: OpenAI.Chat.Completions.ChatCompletionTool = {
    ...
    function: {
      ...
      description: [
        ...
        '2. relevanceScore가 높더라도 노드의 title·nodeType이 질문 맥락과 다르면 근거로 사용하지 마십시오.',
        '3. 검색 결과에 없는 정보를 사용자의 과거 기록인 것처럼 언급하지 마십시오.',
        '4. clusters 배열을 활용해 주제별로 묶어서 설명하면 답변 품질이 향상됩니다.',
      ].join('\n'),
      parameters: {
        type: 'object',
        properties: {
