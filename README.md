...
- **[Daily Dev Logs](docs/guides/Daily)**: 일별 작업 상세 기록
  - [2026-05-20 SDK 문서 및 OpenAPI 명세 동기화](docs/guides/Daily/20260520-sdk-documentation-sync.md)
  - [2026-05-20 에이전트 SSE 스트리밍 및 결과(result) 이벤트 누락 버그 수정](docs/guides/Daily/20260520-agent-sse-stream-and-result-fix.md)
