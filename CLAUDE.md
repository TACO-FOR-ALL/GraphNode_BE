...
| `docs/architecture/DATABASE.md` | DB 스키마 아키텍처 |
...
**DATABASE.md**: `prisma/schema.prisma` 또는 `src/core/types/persistence/**` 수정 완료 후 → `docs/architecture/DATABASE.md` ERD·테이블 즉시 동기화.
